function GameManager(id, board) {
	...
	function checkSquare(row, column) {
		var square = board.rows[row].squares[column];
	...
	this.forJSON = function() {
		var b = { rows: [], currentlyMoving: this.currentlyMoving ? this.currentlyMoving.id : null, scores: getScores() };
